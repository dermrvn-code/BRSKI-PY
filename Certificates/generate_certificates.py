...
print("Generated Manufacturer CA certificate: ", ca_cert_path)
...
print("Generated Pledge IDevID certificate: ", dest_folder)
...
print("Generated MASA CA certificate: ", ca_cert_path)
...
generate_simple_device_cert(
    ...
    dest_folder,
    "DE", "MASA")
print("Generated MASA certificate: ", dest_folder)
