...
def main():
    ...
    print("Setup complete. Virtual environment '.brski_env' is ready and dependencies are installed. Run start_env.bat to activate the environment in the command prompt.")
